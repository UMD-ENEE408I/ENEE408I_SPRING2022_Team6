...
const unsigned int M_RIGHT_IN_1 = 13;
const unsigned int M_RIGHT_IN_2 = 12;
const unsigned int M_LEFT_IN_1 = 25;
const unsigned int M_LEFT_IN_2 = 14;

const unsigned int M_RIGHT_IN_1_CHANNEL = 1;
const unsigned int M_RIGHT_IN_2_CHANNEL = 2;
const unsigned int M_LEFT_IN_1_CHANNEL = 3;
const unsigned int M_LEFT_IN_2_CHANNEL = 4;

const unsigned int M_RIGHT_I_SENSE = 35;
const unsigned int M_LEFT_I_SENSE = 34;
...
void loop() {
  ...
  Encoder encR(M1_ENC_A, M1_ENC_B); //right wheel, forward neg
  Encoder encL(M2_ENC_A, M2_ENC_B); //left wheel, forward pos
  ...
  while(endFlag != 1) {  //"actual main loop"
    ...
    /*if(currentError_L > errorLimit) {
      currentError_L = errorLimit;
    }
    if(currentError_R > errorLimit) {
      currentError_R = errorLimit;
    }*/
